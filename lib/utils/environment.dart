...
class Environment {
  static const ENV_LOCAL_FILE_NAME = '.env.local';
  static const ENV_DEV_FILE_NAME = '.env.development';
  static const ENV_PROD_FILE_NAME = '.env';
