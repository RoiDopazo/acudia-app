      ...
      builder: (context, signup, child) => Column(children: <Widget>[
        TextFormField(
          ...
          validator: MultiValidator([
            RequiredValidator(
                errorText: translate(context, 'field_name_validation_empty')),
            MaxLengthValidator(32,
                errorText:
                    translate(context, 'field_name_validation_max_length')),
          ]),
        ...
        TextFormField(
          ...
          validator: MultiValidator([
            RequiredValidator(
                errorText:
                    translate(context, 'field_second_name_validation_empty')),
            MaxLengthValidator(32,
                errorText: translate(
        ...
        TextFormField(
          ...
          validator: MultiValidator([
            RequiredValidator(
                errorText: translate(context, 'field_email_validation_empty')),
            EmailValidator(
                errorText: translate(context, 'field_email_validation_email')),
          ]),
          decoration: new InputDecoration(
        ...
        TextFormField(
          ...
          validator: MultiValidator([
            RequiredValidator(
                errorText:
                    translate(context, 'field_password_validation_empty')),
            MinLengthValidator(8,
                errorText:
                    translate(context, 'field_password_validation_minlength')),
            PatternValidator(r'(?=.*?[0-9])',
                errorText:
                    translate(context, 'field_password_validation_digits')),
            PatternValidator(r'(?=.*?[A-Z])',
                errorText:
                    translate(context, 'field_password_validation_upper')),
            PatternValidator(r'(?=.*?[a-z])',
                errorText:
                    translate(context, 'field_password_validation_lower')),
          ]),
          decoration: new InputDecoration(
